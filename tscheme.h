/*
  $Id: tscheme.h,v 1.1.1.1 2004/09/09 07:59:50 takuo Exp $
...
#define BANNER "Tscheme: A Tiny Scheme Interpreter\n\
Copyright (c) 1997, 1998 by Takuo Watanabe <takuo@jaist.ac.jp>,\n\
...
#define IS_BOOL(x)      IS_TYPE(x,T_BOOL)
#define BOOL(x) ((x)->as.bool)
...
extern SCM the_null_value, bool_true, bool_false;
extern SCM
  unbound_value, unspecified_value, 
